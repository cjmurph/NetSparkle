...
using NetSparkleForms.Properties;
...
namespace NetSparkleForms
{
    ...
    /// </summary>
    public class DefaultUIFactory : IFormsFactory
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="sparkle">The <see cref="SparkleForms"/> instance to use</param>
        ...
        {
            return new UpdateAvailableWindow(sparkle, updates, applicationIcon, isUpdateAlreadyDownloaded) { Owner = ParentWindow, StartPosition = FormStartPosition.CenterParent };
        }
        ...
        {
            return new DownloadProgressWindow(item, applicationIcon) { Owner = ParentWindow, StartPosition = FormStartPosition.CenterParent };
        }
        ...
        {
            return new CheckingForUpdatesWindow(applicationIcon) { Owner = ParentWindow, StartPosition = FormStartPosition.CenterParent };
        }
        ...
        private void ShowMessage(string title, string message, Icon applicationIcon = null)
        {
            ...
            messageWindow.StartPosition = FormStartPosition.CenterParent;
