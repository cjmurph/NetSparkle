...
using NetSparkle;
using NetSparkleForms.Interfaces;
...
namespace NetSparkleForms
{
    ...
    /// </summary>
    public class SparkleForms : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SparkleForms"/> class with the given appcast URL.
        /// </summary>
        /// <param name="appcastUrl">the URL of the appcast file</param>
        public SparkleForms(string appcastUrl)
        ...
        public SparkleForms(string appcastUrl, Icon applicationIcon)
        ...
        public SparkleForms(string appcastUrl, Icon applicationIcon, SecurityMode securityMode)
        ...
        public SparkleForms(string appcastUrl, Icon applicationIcon, SecurityMode securityMode, string dsaPublicKey)
        ...
        public SparkleForms(string appcastUrl, Icon applicationIcon, SecurityMode securityMode, string dsaPublicKey, string referenceAssembly)
        ...
        public Form ParentWindow { get => UIFactory.ParentWindow; set => UIFactory.ParentWindow = value; }
        ...
        /// </summary>
        public IFormsFactory UIFactory { get; set; }
        ...
        private void UnregisterEvents()
        {
            ...
            {
                ProgressWindow.DownloadProcessCompleted -= OnProgressWindowInstallAndRelaunch;
                ProgressWindow = null;
            }
        ...
        /// <param name="sender">not used.</param>
        /// <param name="e">not used.</param>
        private void OnProgressWindowInstallAndRelaunch(object sender, NetSparkle.Events.DownloadInstallArgs e)
        {
